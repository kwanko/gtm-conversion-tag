...

{
  ...
  "description": "This tag will give you the opportunity to trigger any type of conversion supported by Kwanko using our latest tracking features like uniJS and first party.",
  "containerContexts": [
    "WEB"
  ]
}
